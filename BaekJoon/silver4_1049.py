...
for _ in range(m):
    ...
    brand_six.append(six)
    brand_one.append(one)

brand_six = min(brand_six)
brand_one = min(brand_one)

if brand_six < brand_one * 6:
    if brand_six < (n % 6) * brand_one:
        print((n//6) * brand_six + brand_six)
    else:
        print((n//6) * brand_six + (n % 6) * brand_one)
elif brand_six >= brand_one * 6:
    print(n * brand_one)
